...
import WrapperInput from "@/components/Layouts/parts/Login/WrapperInput";
      ...
      <article className="split-screen relative flex flex-col md:flex-row md:h-screen">
        ...
        <div className="column-right flex justify-center items-center md:flex md:h-auto md:w-1/2">
          <form className="w-80">
            ...
            <button className="btn-signup cursor-pointer block w-full bg-blue-900 text-white font-semibold border-none p-3 mt-8 rounded-xl text-sm hover:bg-blue-800 transition-all focus:outline-none">
              Masuk
            </button>
            ...
            <div className="copy legal-option text-left mt-8">
              <span className="text-sm font-medium text-gray-500">
                ...
                <a
                  href="/"
                  className="text-lg text-gray-700/90 underline hover:no-underline"
                >
                  Google
                </a>
              </span>
