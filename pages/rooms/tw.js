...
import DetailsContent from "@/components/Layouts/parts/Detail/DetailsContent";
...
export default function TwRoom({ searchResult }) {
  ...
  return (
    <>
      ...
      <LayoutDetail
        placeholder={`${location} | ${range} | ${guestNumber} tamu`}
      >
        <DetailsContent
          location={location}
...
export async function getServerSideProps() {
  const searchResult = await fetch("https://jsonkeeper.com/b/EZTD").then(
    (res) => res.json()
  );
