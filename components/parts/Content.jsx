    ...
    return (
        <article className="max-w-7xl mx-auto px-8 sm:px-16">
            <section className="py-6">
                <h2 className="text-3xl font-bold pb-5 text-gray-700 select-none">Explore Nearby</h2>
            ...
            <section className="py-6">
                <h2 className="text-3xl font-bold pb-5 text-gray-700 select-none">Live Anywhere</h2>
            ...
            <section className="py-16 relative cursor-pointer">
                <LargeCard
                    ...
                    description="Wishlists curated by Twill."
