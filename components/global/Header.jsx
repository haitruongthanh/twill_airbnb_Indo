...
export default function Header({ isClean, isNotClean }) {
                    ...
                    <nav className="grid grid-cols-2 sm:grid-cols-3">
                        ...
                        <div className="flex items-center space-x-3 md:space-x-4 justify-end">
                            ...
                            <div className="flex items-center relative space-x-2 text-blue-700 border-2 p-2 rounded-xl duration-300 transition hover:shadow-md">
                                ...
                                <span className="absolute animate-bounce right-2 border-2 border-white top-3 -mt-2 -mr-1 text-xs text-white font-medium bg-red-500 h-3 w-3 shadow-lg rounded-full"></span>
                            </div>
                        </div>
                    </nav>
                    {searchInput && (
                    ...
                    <nav className="grid grid-cols-2 sm:grid-cols-3">
                        ...
                        <div className="flex items-center space-x-3 md:space-x-4 justify-end">
                            ...
                            <div className="flex items-center relative space-x-2 text-blue-700 border-2 p-2 rounded-xl duration-300 transition hover:shadow-md">
                                ...
                                <span className={["absolute animate-bounce right-2 border-2 border-white top-3 -mt-2 -mr-1 text-xs text-white font-medium h-3 w-3 shadow-lg rounded-full", isShadow ? "bg-red-500" : "bg-green-500"].join(" ")}></span>
                            </div>
                        </div>
                        ...
                        {searchInput && (
                            <div className={["flex flex-col col-span-3 mt-4 md:mt-7 p-3 bg-white rounded-b-2xl rounded-t-lg mx-auto", isShadow ? 'shadow-bar' : ''].join(" ")}>
                                ...
                                <div className="px-2 pt-3 inline-flex items-center border-b mb-6">
                                    <h2 className="flex-grow text-base font-medium text-gray-700 leading-normal">Number of guest</h2>
                                ...
                                <div className="flex items-center space-x-4 px-2">
                                    <button onClick={resetInput} className="flex-grow outline-none select-none text-sm font-medium border-2 border-red-400 text-red-400 py-2 px-6 rounded-xl hover:bg-red-200 duration-300 transition">Cancel</button>
                                    <button className="flex-grow outline-none select-none text-sm font-medium border-2 border-gray-700 text-gray-700 py-2 px-6 rounded-xl hover:bg-gray-200 duration-300 transition">Search</button>
                                </div>
                            </div>
                        )}
                    </nav>
